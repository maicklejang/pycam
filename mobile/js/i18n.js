...
(function (root) {
    ...
    var STRINGS = {
        ko: {
            ...
            measure: "치수 측정",
            section: "단면도",
            sectionFlip: "자르는 방향 반대로",
            theme: "배경", themeLight: "밝은 회색", themeDark: "어두움",
            partColors: "부품별 색상",
            clearMeasure: "측정 지우기",
        ...
        en: {
            ...
            sectionFlip: "Cut from the other side",
            theme: "Background", themeLight: "Light grey", themeDark: "Dark",
            partColors: "Colour parts separately",
